...
SILDeclRef::SILDeclRef(ValueDecl *vd, SILDeclRef::Kind kind,
                       bool isCurried, bool isForeign, bool isTest)
  : loc(vd), kind(kind),
    isCurried(isCurried), isForeign(isForeign),
    isDirectReference(0), isTestThunk(isTest), defaultArgIndex(0)
{}

SILDeclRef::SILDeclRef(SILDeclRef::Loc baseLoc,
                       bool isCurried, bool asForeign, bool isTest)
  : isCurried(isCurried), isDirectReference(0), isTestThunk(isTest),
    defaultArgIndex(0)
{
