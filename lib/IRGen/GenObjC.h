...
namespace irgen {
  ...
  public:
    ObjCMethod(SILDeclRef method, bool direct, SILType searchType, bool startAtSuper)
      : method(method), searchTypeAndSuper(searchType, startAtSuper), direct(direct)
    {}
  ...
  Callee getObjCDirectMethodCallee(IRGenFunction &IGF,
                                   const ObjCMethod &fn,
