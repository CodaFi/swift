...
_ = B<String>.S2()
// expected-error@-1 {{'A.S2' (aka 'Int') requires the types '[String]' and '[Int]' be equivalent}}
...
_ = S<Int>.C()         // expected-error {{'S.C' (aka 'Int') requires the types 'Int' and 'Float' be equivalent}}
