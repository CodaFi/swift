...
// CHECK-LABEL: @"$sl26existential_shape_metadata2Q0_px1TRtz_XPXGMq" = linkonce_odr hidden constant
// CHECK-SAME:  { i32 {{.*}}sub ([[INT]] ptrtoint (i8** @{{[0-9]+}} to [[INT]])
// CHECK-SAME:    i32 6400,
// CHECK-SAME:    i32 {{.*}} @"flat unique 26existential_shape_metadata2Q0_px1TAaBPRtz_XP"
// CHECK-SAME:    i16 2, i16 2, i16 3, i16 0,
// CHECK-SAME:    i16 1, i16 0, i16 1, i16 0, i32 1,

// CHECK-LABEL: @"$sl26existential_shape_metadata2R033_881A0B6978EB4286E7CFF1E27030ACACLL_px1TRtz_XPXG" = internal constant
// CHECK-SAME:  { i32 6400,
//   This could use a symbolic reference because this doesn't have to be uniqued.
// CHECK-SAME:    i32 {{.*}} @"flat unique 26existential_shape_metadata2R033_881A0B6978EB4286E7CFF1E27030ACACLL_px1TAabCLLPRtz_XP"
// CHECK-SAME:    i16 2, i16 2, i16 3, i16 0,
// CHECK-SAME:    i16 1, i16 0, i16 1, i16 0, i32 1,
...
public func testConcrete() -> Any.Type {
  // CHECK: [[T0:%.*]] = call swiftcc %swift.metadata_response @"$s26existential_shape_metadata2Q0_pSi1TAaBPRtz_XPMa"([[INT]] 0)
  // CHECK: [[METADATA:%.*]] = extractvalue %swift.metadata_response [[T0]], 0
  // CHECK: ret %swift.type* [[METADATA]]
  return (any Q0<Int>).self
}

// CHECK-LABEL: define{{.*}} linkonce_odr hidden swiftcc %swift.metadata_response @"$s26existential_shape_metadata2Q0_pSi1TAaBPRtz_XPMa"(
  // CHECK: [[ENTRY:.*]]:
  // CHECK:   [[ARGS:%.*]] = alloca [1 x i8*], align
  // CHECK:   [[LOAD:%.*]] = load %swift.type*, %swift.type** @"$s26existential_shape_metadata2Q0_pSi1TAaBPRtz_XPML", align
  ...
  // CHECK:   [[CALL:%.*]] = call %swift.type* @swift_getExtendedExistentialTypeMetadata({{.*}}@"$sl26existential_shape_metadata2Q0_px1TRtz_XPXGMq{{(\.ptrauth)?}}" to i8*), i8** [[T0]])
  // CHECK:   store atomic %swift.type* [[CALL]], %swift.type** @"$s26existential_shape_metadata2Q0_pSi1TAaBPRtz_XPML" release, align
  // CHECK:   br label %[[CONT]]
  // CHECK: [[CONT]]:
...
public func testDependent<T>(t: T.Type) -> Any.Type {
  ...
  // CHECK: [[T0:%.*]] = bitcast [1 x i8*]* [[ARGS]] to i8**
  // CHECK: [[METADATA:%.*]] = call %swift.type* @swift_getExtendedExistentialTypeMetadata({{.*}}@"$sl26existential_shape_metadata2Q0_px1TRtz_XPXGMq{{(\.ptrauth)?}}" to i8*), i8** [[T0]])
  // CHECK: ret %swift.type* [[METADATA]]
...
public func test_private<T>(t: T.Type) -> Any.Type {
  ...
  // CHECK: [[METADATA:%.*]] = call %swift.type* @swift_getExtendedExistentialTypeMetadata_unique({{.*}}@"$sl26existential_shape_metadata2R033_881A0B6978EB4286E7CFF1E27030ACACLL_px1TRtz_XPXG{{(\.ptrauth)?}}" to i8*), i8** [[T0]])
  // CHECK: ret %swift.type* [[METADATA]]
...
public func test_privateApplication<T>(t: T.Type) -> Any.Type {
  // CHECK: [[T0:%.*]] = call swiftcc %swift.metadata_response @"$s26existential_shape_metadata2Q0_pAA1C33_881A0B6978EB4286E7CFF1E27030ACACLLV1TAaBPRtz_XPMa"([[INT]] 0)
  // CHECK: [[METADATA:%.*]] = extractvalue %swift.metadata_response [[T0]], 0
  // CHECK: ret %swift.type* [[METADATA]]
...
// CHECK-LABEL: define{{.*}} linkonce_odr hidden swiftcc %swift.metadata_response @"$s26existential_shape_metadata2Q0_pAA1C33_881A0B6978EB4286E7CFF1E27030ACACLLV1TAaBPRtz_XPMa"(
  // CHECK: [[ARGS:%.*]] = alloca [1 x i8*], align
  // CHECK: [[T0:%.*]] = getelementptr inbounds [1 x i8*], [1 x i8*]* [[ARGS]], i32 0, i32 0
